			  ...
			  struct device *ipa_dev)
{
	...
	char exec_path[] = "/system/bin/setprop";
	char *argv_prop[] = { exec_path,"ipa_complete","1",NULL };
	int Return_code = 0;
	//
	if (ipa3_ctx == NULL) {
	...
	//SSD_RIL add
	Return_code = call_usermodehelper(exec_path, argv_prop, envp, UMH_WAIT_PROC);
	pr_info("Call call_usermodehelper, and Return code = %d \n", Return_code);
	//
	return 0;
