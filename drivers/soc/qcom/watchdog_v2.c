...
bool __read_mostly do_not_wakeup_pet_task = false;
module_param_named(do_not_wakeup_pet_task, do_not_wakeup_pet_task, bool, 0600);
#endif
...
#if defined(CONFIG_HTC_DEBUG_WATCHDOG)
	set_restart_action(RESTART_REASON_RAMDUMP, "NS-DOG: watchdog bite");
#endif
